...
#SBATCH -J methylSeq_puc19
#SBATCH -e /path/to/project/diretory/puc19/logs/methylSeq_%j.log
#SBATCH -o /path/to/project/diretory/puc19/logs/methylSeq_%j.log
...
export NXF_WORK=$ANALYSISDIR/puc19/work
export NXF_HOME=$ANALYSISDIR/puc19/work
...
nextflow run $ANALYSISDIR/methylseq/nf-core-methylseq-1.6.1/workflow/main.nf -resume -profile uppmax,singularity -c $ANALYSISDIR/methylseq.config \
	...
	--fasta $ANALYSISDIR/puc19_NEB.fa \ #path to reference genome
