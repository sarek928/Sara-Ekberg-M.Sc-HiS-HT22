...
#SBATCH -J methylSeq_bwa_emseq
#SBATCH -e /path/to/project/directory/bwa/emseq/logs/methylSeq_%j.log
#SBATCH -o /path/to/project/directory/bwa/emseq/logs/methylSeq_%j.log
...
export NXF_WORK=$ANALYSISDIR/bwa/emseq/work
export NXF_HOME=$ANALYSISDIR/bwa/emseq/work
...
nextflow run $ANALYSISDIR/methylseq/nf-core-methylseq-1.6.1/workflow/main.nf -resume -profile uppmax,singularity -c $ANALYSISDIR/methylseq.config \
	...
	--outdir $ANALYSISDIR/bwa/emseq/results \
	--em_seq \
	--save_reference 
